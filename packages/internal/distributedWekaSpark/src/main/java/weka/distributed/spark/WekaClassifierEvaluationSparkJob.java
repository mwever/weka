...
public class WekaClassifierEvaluationSparkJob extends SparkJob implements
  ...
  public boolean runJobWithContext(JavaSparkContext sparkContext)
    ...
    try {
      ...
      Evaluation results =
        phaseTwoEvaluateClassifiers(dataset != null ? dataset : dataSet,
          headerWithSummary, headerNoSummary, foldClassifiers);

      storeAndWriteEvalResults(results, headerNoSummary, totalFolds, seed,
        outputPath);
  ...
  protected void storeAndWriteEvalResults(Evaluation aggregated,
    Instances headerNoSummary, int totalFolds, String seed, String outputPath)
    throws IOException {
