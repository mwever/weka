...
/**
 * <!-- globalinfo-start --> This method constructs a decision tree based classifier that maintains
 ...
 * in randomly chosen subspaces.<br/>
 * <br/>
...
public class RandomSubSpace extends RandomizableParallelIteratedSingleClassifierEnhancer implements WeightedInstancesHandler, TechnicalInformationHandler {
	...
	public RandomSubSpace() {
		...
		this.m_Classifier = new weka.classifiers.trees.REPTree();
	}
	...
	public String globalInfo() {
		return "This method constructs a decision tree based classifier that " + "maintains highest accuracy on training data and improves on " + "generalization accuracy as it grows in complexity. The classifier "
				+ "consists of multiple trees constructed systematically by " + "pseudorandomly selecting subsets of components of the feature vector, " + "that is, trees constructed in randomly chosen subspaces.\n\n"
