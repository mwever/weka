...
/**
 * <!-- globalinfo-start --> Class for bagging a classifier to reduce variance. Can do
 ...
 * @version $Revision$
 */
public class Bagging extends RandomizableParallelIteratedSingleClassifierEnhancer
   ...
   */
  @Override
  public Bagging aggregate(final Bagging toAggregate) throws Exception {
