...
/**
 * <!-- globalinfo-start --> Learns a simple linear regression model. Picks the attribute that
 * results in the lowest squared error. Can only deal with numeric attributes.
 * <p/>
 * <!-- globalinfo-end -->
 * 
