...
/**
 * <!-- globalinfo-start --> Class for building and using a multinomial logistic regression model with a ridge estimator.<br/>
 * <br/>
 ...
 * } + ridge * (B^2)<br/>
 * <br/>
 * In order to find the matrix B for which L is minimised, a Quasi-Newton Method is used to search for the optimized values of the m*(k-1) variables. Note that before we use the optimization procedure, we 'squeeze' the matrix B into a
 * m*(k-1) vector. For details of the optimization procedure, please check weka.core.Optimization class.<br/>
 * <br/>
...
public class Logistic extends AbstractClassifier implements OptionHandler, WeightedInstancesHandler, TechnicalInformationHandler, PMMLProducer, Aggregateable<Logistic> {
	...
	public String globalInfo() {
		return "Class for building and using a multinomial logistic " + "regression model with a ridge estimator.\n\n" + "There are some modifications, however, compared to the paper of " + "leCessie and van Houwelingen(1992): \n\n"
				...
				+ "In order to find the matrix B for which L is minimised, a " + "Quasi-Newton Method is used to search for the optimized values of " + "the m*(k-1) variables.  Note that before we use the optimization "
				+ "procedure, we 'squeeze' the matrix B into a m*(k-1) vector.  For " + "details of the optimization procedure, please check " + "weka.core.Optimization class.\n\n"
	...
	private class OptObject {
		 ...
		 *
		 * This is based on Tobias P. Mann's description in "Numerically Stable Hidden Markov Implementation" (2006).
		 */
	 ...
	 * @throws InterruptedException
	 */
	private double[] evaluateProbability(final double[] data) throws InterruptedException {
