...
public class NormalizedPolyKernel extends PolyKernel {
	 ...
	 */
	public NormalizedPolyKernel(final Instances dataset, final int cacheSize, final double exponent, final boolean lowerOrder) throws Exception {
	 ...
	 */
	@Override
	public void setExponent(final double value) {
		if (value != 1.0) {
	...
	public String toString() {
		...
		if (this.getUseLowerOrder()) {
			result = "Normalized Poly Kernel with lower order: K(x,y) = (<x,y>+1)^" + this.getExponent() + "/" + "((<x,x>+1)^" + this.getExponent() + "*" + "(<y,y>+1)^" + this.getExponent() + ")^(1/2)";
		} else {
			result = "Normalized Poly Kernel: K(x,y) = <x,y>^" + this.getExponent() + "/" + "(<x,x>^" + this.getExponent() + "*" + "<y,y>^" + this.getExponent() + ")^(1/2)";
		}
