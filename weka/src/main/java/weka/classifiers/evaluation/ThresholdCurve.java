...
public class ThresholdCurve implements RevisionHandler {
	 ...
	 */
	public Instances getCurve(final ArrayList<Prediction> predictions) throws InterruptedException {
	 ...
	 * @throws InterruptedException
	 */
	public Instances getCurve(final ArrayList<Prediction> predictions, final int classIndex) throws InterruptedException {
	...
	* @throws InterruptedException
	 */
	public static double getNPointPrecision(final Instances tcurve, final int n) throws InterruptedException {
	 ...
	 *         generated Instances.
	 */
	public static double getPRCArea(final Instances tcurve) {
	 ...
	 *         generated Instances.
	 */
	public static double getROCArea(final Instances tcurve) {
	 ...
	 * @throws InterruptedException
	 */
	public static int getThresholdInstance(final Instances tcurve, final double threshold) throws InterruptedException {
	 ...
	 */
	private static int binarySearch(final int[] index, final double[] vals, final double target) {
	 ...
	 */
	private double[] getProbabilities(final ArrayList<Prediction> predictions, final int classIndex) {
	 ...
	 */
	private Instance makeInstance(final TwoClassStats tc, final double prob) {
