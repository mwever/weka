...
public class SimpleEstimator extends BayesNetEstimator {
	 ...
	 */
	@Override
	public void estimateCPTs(final BayesNet bayesNet) throws Exception {
	 ...
	 */
	@Override
	public void updateClassifier(final BayesNet bayesNet, final Instance instance) throws Exception {
	 ...
	 */
	@Override
	public void initCPTs(final BayesNet bayesNet) throws Exception {
	 ...
	 */
	@Override
	public double[] distributionForInstance(final BayesNet bayesNet, final Instance instance) throws Exception {
		Instances instances = bayesNet.m_Instances;
