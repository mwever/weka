...
public class HillClimber extends GlobalScoreSearchAlgorithm {
	 ...
	 *             if something goes wrong
	 */
	Operation findBestArcToAdd(final BayesNet bayesNet, final Instances instances, Operation oBestOperation) throws Exception {
	 ...
	 */
	Operation findBestArcToDelete(final BayesNet bayesNet, final Instances instances, Operation oBestOperation) throws Exception {
		int nNrOfAtts = instances.numAttributes();
	 ...
	 *             if something goes wrong
	 */
	Operation findBestArcToReverse(final BayesNet bayesNet, final Instances instances, Operation oBestOperation) throws Exception {
		int nNrOfAtts = instances.numAttributes();
