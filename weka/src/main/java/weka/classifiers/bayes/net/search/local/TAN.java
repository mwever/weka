...
/**
 * <!-- globalinfo-start --> This Bayes Network learning algorithm determines the maximum weight spanning tree and returns a Naive Bayes network augmented with a tree.<br/>
 * <br/>
		...
		for (int iAttributeHead = 0; iAttributeHead < nNrOfAtts; iAttributeHead++) {
			for (int iAttributeTail = 0; iAttributeTail < nNrOfAtts; iAttributeTail++) {
				...
				if (iAttributeHead != iAttributeTail) {
					fScore[iAttributeHead][iAttributeTail] = this.calcScoreWithExtraParent(iAttributeHead, iAttributeTail);
				}
			}
		}
