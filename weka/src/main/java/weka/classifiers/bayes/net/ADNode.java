...
public class ADNode implements Serializable, TechnicalInformationHandler, RevisionHandler {
	 ...
	 **/
	public static VaryNode makeVaryNode(final int iNode, final ArrayList<Integer> nRecords, final Instances instances) throws InterruptedException {
	 ...
	 * @throws InterruptedException
	 */
	public static ADNode makeADTree(final int iNode, final ArrayList<Integer> nRecords, final Instances instances) throws InterruptedException {
	 ...
	 * @throws InterruptedException
	 */
	public static ADNode makeADTree(final Instances instances) throws InterruptedException {
	 ...
	 * @throws InterruptedException
	 */
	public void getCounts(final int[] nCounts, final int[] nNodes, final int[] nOffsets, final int iNode, final int iOffset, final boolean bSubstract) throws InterruptedException {
