...
public class REPTree extends AbstractClassifier implements OptionHandler, WeightedInstancesHandler, Drawable, AdditionalMeasureProducer, Sourcable, PartitionGenerator, Randomizable {
	...
	public String globalInfo() {
		...
		return "Fast decision tree learner. Builds a decision/regression tree using " + "information gain/variance and prunes it using reduced-error pruning " + "(with backfitting).  Only sorts values for numeric attributes "
				+ "once. Missing values are dealt with by splitting the corresponding " + "instances into pieces (i.e. as in C4.5).";
	}
	...
	protected class Tree implements Serializable, RevisionHandler {
		 ...
		 *           if generation fails
		 */
		protected void buildTree(final int[][][] sortedIndices, final double[][][] weights, final Instances data, final double totalWeight, final double[] classProbs, final Instances header, final double minNum, final double minVariance,
				final int depth, final int maxDepth) throws Exception {
		 ...
		 *           if something goes wrong
		 */
		protected void splitData(final int[][][][] subsetIndices, final double[][][][] subsetWeights, final int att, final double splitPoint, final int[][] sortedIndices, final double[][] weights, final Instances data) throws Exception {
		 ...
		 *           if computation fails
		 */
		protected double distribution(final double[][] props, final double[][][] dists, final int att, final int[] sortedIndices, final double[] weights, final double[][] subsetWeights, final Instances data) throws Exception {
		 ...
		 *           if computation fails
		 */
		protected double numericDistribution(final double[][] props, final double[][][] dists, final int att, final int[] sortedIndices, final double[] weights, final double[][] subsetWeights, final Instances data, final double[] vals)
				throws Exception {
